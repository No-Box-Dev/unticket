      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleManualSubmit} className="mt-4 flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 text-sm border border-stone-200 rounded-lg bg-white text-stone-900 focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent"
          />
          <button
            type="submit"
            disabled={!manualOrg.trim()}
            className="px-4 py-2 text-sm font-medium text-white bg-accent rounded-lg hover:bg-accent/90 disabled:opacity-50 cursor-pointer"
          >
            Go
          </button>
        </form>
